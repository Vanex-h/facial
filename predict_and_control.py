...
ser = serial.Serial("COM11", 9600)  # Change port to your Arduino's port
...
while True:
    ...
    elif is_access_granted & is_vip_granted:
        ser.write(b"2")  # Sending '2' to Arduino to turn on Blue LED
    else:
